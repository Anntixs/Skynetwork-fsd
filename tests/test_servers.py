"""Integration tests: start the real skynet-fsd / skynet-voice binaries and talk to them.

Run after building:  cmake -S server -B build && make -C build && python3 -m unittest discover -s tests
"""
import json
import os
import socket
...
class Network(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.port, cls.http_port, cls.voice_port = free_port(), free_port(), free_port(socket.SOCK_DGRAM)
        cls.procs = [
